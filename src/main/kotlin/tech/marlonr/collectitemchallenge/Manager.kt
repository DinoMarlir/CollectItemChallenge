...
class Manager: KSpigot() {
    ...
    override fun startup() {
        ...
        listen<EntityPickupItemEvent> {
            ...
            it.entity.teleport(Location(it.entity.location.world, x.toDouble().plus(it.entity.location.x), it.entity.world.getHighestBlockAt(x, z).y.toDouble() + 1, z.toDouble().plus(it.entity.location.z)))
        }
    }
}